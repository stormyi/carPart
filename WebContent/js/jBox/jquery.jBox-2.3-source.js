(function(a) {
    a.jBox = function(b, c) {
        ...
        j.push('<div class="jbox-help-title jbox-title-panel" style="height:28px;display:none;"></div>');
        j.push('<div class="jbox-help-button jbox-button-panel" style="height:28px;padding:5px 0 5px 0;display:none;"></div>');
        ...
        if (g) {
            j.push('<div class="jbox-title-panel" style="height:28px;">');
            j.push('<div class="jbox-title' + (c.showIcon == true ? ' jbox-title-icon': (c.showIcon == false ? '': ' ' + c.showIcon)) + '" style="float:left; width:' + i + '; line-height:' + (a.browser.msie ? 28 : 28) + 'px; padding-left:' + (c.showIcon ? 22 : 0x0) + 'px;overflow:hidden;text-overflow:ellipsis;word-break:break-all;">' + (c.title == '' ? '&nbsp;': c.title) + '</div>');
            j.push('</div>')
        };
        ...
        function(N, O) {
            ...
            r.push('<div class="jbox-button-panel" style="height:28px;padding:5px 0 5px 0;text-align: right;' + (P ? '': 'display:none;') + '">');
            if (!c.isTip) {
                r.push('<span class="jbox-bottom-text" style="float:left;display:block;line-height:28px;"></span>')
            };
            a.each(O.buttons,
            function(T, U) {
        ...
        var B = function() {
            if (c.isMessager) {
                ...
                o.css({
                    position: "absolute",
                    top: c.isTip ? (q.offset().top+l.scrollTop()) : ((l.height() - o.outerHeight()) / 0x2),
        ...
        var I = function() {
            if (!c.isTip && !c.isMessager) {
                ...
                if (c.isTip) {
                    var b = a(document.body).data('tip');
                    if (b && b.next == true) {
                        q.css('top', b.options.top);
                        var N = q.offset().top + l.scrollTop();
                        if (N == o.offset().top) {
                            J()
                        } else {
                            o.find('#jbox-content').html(b.options.content.substr(0x0)).end().css({
                                left: ((l.width() - o.outerWidth()) / 0x2)
                            }).animate({
                                top: N,
                                opacity: 0.1
        ...
        if (c.isMessager) {
            ...
            var W = a(document.body).data('tip');
            if (W && W.next == true) {
    ...
    a.jBox.prompt = function(b, c, d, e) {
        ...
        if (e.icon != 'info' && e.icon != 'info' && e.icon != 'success' && e.icon != 'error' && e.icon != 'question') {
            padding = '';
            e.icon = 'none'
        };
    ...
    a.jBox.tip = function(b, c, d) {
        ...
        if (d.icon != 'info' && d.icon != 'info' && d.icon != 'success' && d.icon != 'error' && d.icon != 'loading') {
            d.icon = 'info'
        };
        var e = [];
        e.push('html:');
