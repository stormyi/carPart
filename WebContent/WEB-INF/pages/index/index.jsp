...
<iframe allowtransparency=true id="body"  src="${ctx}/index/dynmsn.shtml" width="100%"  frameborder="0" scrolling="auto" name="body" onload="javascript:dyniframesize('body');"></iframe>
